...
class DanmakuMessage:
    ...
    def from_command(cls, data: dict):
        return cls(
            ...
            emoji_img_url=data.get("emoji_img_url", ""),
            dm_type=data.get("dm_type", 0),
            glory_level=data.get("glory_level", 0),
            reply_open_id=data.get("reply_open_id", ""),
            reply_uname=data.get("reply_uname", ""),
...
class GiftMessage:
    ...
    def from_command(cls, data: dict):
        ...
        return cls(
            ...
            price=data["price"],
            r_price=data.get("r_price", data["price"]),  # r_price 没通过测试
            paid=data["paid"],
            fans_medal_level=data["fans_medal_level"],
            fans_medal_name=data["fans_medal_name"],
            fans_medal_wearing_status=data["fans_medal_wearing_status"],
...
class SuperChatMessage:
    ...
    def from_command(cls, data: dict):
        return cls(
            ...
            rmb=data["rmb"],  # 不知道为啥无论选什么发出来的都是0
            timestamp=data["timestamp"],
